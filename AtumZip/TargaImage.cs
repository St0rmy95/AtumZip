        ...
        private PixelFormat GetPixelFormat()
        {
            ...
            switch (this.objTargaHeader.PixelDepth)
            {
                ...
                case 32:
                    if (this.Format == TGAFormat.NEW_TGA && this.objTargaFooter.ExtensionAreaOffset > 0)
                    {
                        // accoroding to the specification:
                        // "...the file is assumed to be in the New TGA format and MAY, therefore, contain the Developer Area
                        // and/or the Extension Area fields."
                        ...
                        switch (this.objTargaExtensionArea.AttributesType)
                        {
                            case 0: // no alpha data included
                                ...
                                break;
                            case 1: // undefined data in alpha field, can be ignored
                            case 2: // undefined data in alpha field, but should be retained
                            case 3: // useful alpha channel data is present
                    ...
                    {
                        // the file is in the Original TGA format and does not contain Extension Area fields.
                        // so it does not contain Attributes Type field.
                        pfTargaPixelFormat = PixelFormat.Format32bppArgb;
                    }
